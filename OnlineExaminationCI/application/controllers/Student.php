...
class Student extends CI_Controller
{
    ...
    private function validasi_mahasiswa($method)
    {
        ...
        $this->form_validation->set_rules('jurusan', 'Department', 'required');
    ...
    public function create_user()
    {
        ...
        if ($this->ion_auth->username_check($username)) {
            ...
            $data = [
                'status' => true,
                'msg' => 'User created successfully. Student ID is used as a password at login.'
            ];
        }
        $this->output_json($data);
    }
    ...
    {
        // Reuse the exact logic from Mahasiswa::preview
