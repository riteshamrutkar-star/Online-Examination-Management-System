<div class="row">
    <div class="col-sm-12">    
        <?=form_open_multipart('question/save', array('id'=>'formsoal'), array('method'=>'edit', 'id_soal'=>$soal->id_soal));?>
        <div class="box">
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                ...
                                <input required="required" value="<?=$soal->bobot?>" type="number" name="bobot" placeholder="Question Weight" id="bobot" class="form-control">
